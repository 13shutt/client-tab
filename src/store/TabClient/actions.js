import { DELETE_ITEM, EDIT_ITEM, ADD_ITEM, EDIT_ABOUT } from './constants'
...
const editAbout = data => dispatch => {
  dispatch({type: EDIT_ABOUT, payload: data})
}

export { deleteItem, editItem, addItem, editAbout }